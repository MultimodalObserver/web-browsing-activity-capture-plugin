...
public abstract class CaptureHandler {
    ...
    void writeCaptureFile(InputStream inputStream, FileOutputStream fileOutputStream, long captureMilliseconds){
        ...
        for (Object line : jsonArray){
            try {
                ...
                String realLine = String.valueOf(line) + LINE_SEPARATOR;
