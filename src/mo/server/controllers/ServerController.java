package mo.server.controllers;

import mo.communication.streaming.capture.PluginCaptureListener;
import mo.plugin.WebBrowsingActivityConfiguration;
import mo.plugin.WebBrowsingActivityRecorder;
import mo.server.middleware.Cors;
import mo.server.router.Router;
import mo.server.views.ServerConfigurationView;
    ...
    private void deleteOutputFiles(){
        for (Object key : this.outputFilesMap.keySet()) {
            Map<String, Object> subMap = this.outputFilesMap.get(key);
                ...
                System.out.println("VOY A BORRAR " + outputFile.getAbsolutePath());
