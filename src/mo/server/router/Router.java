...
import mo.server.handlers.interfaces.StartEndpoint;
...
public class Router implements HttpHandler {
    ...
    private static final String BASE_PACKAGE = "mo.server.";
    ...
    public Router(ServerController serverController){
        ...
        RouteHandlerInfo startPostHandlerInfo = new RouteHandlerInfo(BASE_PACKAGE + "handlers.StartHandler", "start");
        ...
        try {
            ...
            if(instance instanceof CaptureEndpoint){
                Method method = handlerClass.getMethod(handlerClassMethodName, HttpExchange.class, FileOutputStream.class,
                        long.class, List.class, String.class, WebBrowsingActivityRecorder.class);
                ...
                List<PluginCaptureListener> dataListeners = this.serverController.getDataListeners();
                String configurationId = this.serverController.getConfigurationId();
                WebBrowsingActivityRecorder recorder = this.serverController.getRecorder();
                method.invoke(instance,exchange, fileOutputStream, captureMilliseconds, dataListeners,
                        configurationId, recorder);
            }
